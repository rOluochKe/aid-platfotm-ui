...
export const sendMessage = (mesg) => {
  return (dispatch) => {
    ...
    axios({
      method: 'POST',
      url: 'https://aid-platform-ror-api.herokuapp.com/api/v1/messages',
      headers: {
...
export const getMessages = () => {
  return (dispatch) => {
    axios({
      method: 'GET',
      url: 'https://aid-platform-ror-api.herokuapp.com/api/v1/my-messages',
      headers: {
        'Content-Type': 'application/json',
        Authorization: setAuthToken(),
      },
...
export const messageNotification = () => {
  return (dispatch) => {
    axios({
      method: 'GET',
      url: 'https://aid-platform-ror-api.herokuapp.com/api/v1/notifications',
      headers: {
        'Content-Type': 'application/json',
        Authorization: setAuthToken(),
      },
...
export const chatMessages = (request_id, user_id) => {
  return (dispatch) => {
    axios({
      method: 'GET',
      url: `https://aid-platform-ror-api.herokuapp.com/api/v1/chat/${request_id}/${user_id}`,
      headers: {
        'Content-Type': 'application/json',
        Authorization: setAuthToken(),
      },
...
export const readStatus = (request_id, user_id) => {
  return (dispatch) => {
    axios({
      method: 'PATCH',
      url: `https://aid-platform-ror-api.herokuapp.com/api/v1/read-status/${request_id}/${user_id}`,
      headers: {
        'Content-Type': 'application/json',
        Authorization: setAuthToken(),
      },
